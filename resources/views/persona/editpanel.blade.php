					...
					<div class="card-body">
						...
						<div class="row">
							...
							<div class="col-xs-12 col-sm-12 col-md-6">
								<div class="form-group">
									<label>NOMBRE</label>
									<br>
									<input type="text" name="nombrePersona" id="nombrePersona" class="form-control input-sm inputBordes" style="color: #1e1e27" value="{{ $persona->nombrePersona }}" placeholder="Pedro" required>
							...
							<div class="col-xs-12 col-sm-12 col-md-6">
								<div class="form-group">
									...
									<br>
									<input type="text" name="apellidoPersona" id="apellidoPersona" class="form-control input-sm inputBordes" style="color: #1e1e27" value="{{ $persona->apellidoPersona }}" placeholder="Sanchez" required>
						...
						<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-6">
								<div class="form-group">
									<label>DNI</label><br>
									<input type="text" name="dniPersona" id="dniPersona" class="form-control input-sm inputBordes" style="color: #1e1e27" value="{{$persona->dniPersona }}" placeholder="12345678" required>
							...
							<div class="col-xs-12 col-sm-12 col-md-6">
								<div class="form-group">
									...
									<input type="text" name="telefonoPersona" id="telefonoPersona" class="form-control input-sm inputBordes" style="color: #1e1e27" value="{{ $persona->telefonoPersona }}" placeholder="(299)15123456" required>
