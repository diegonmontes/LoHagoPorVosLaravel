...
<div id="chatter" class="chatter_home">
	        	...
	        	<div class="panel">
		        	<ul class="discussions">
		        		@foreach($discussions as $discussion)
				        	<li>
				        		<a class="discussion_list" href="/{{ Config::get('chatter.routes.root') }}/{{ Config::get('chatter.routes.discussion') }}/{{ $discussion->category->slug }}/{{ $discussion->slug }}">
	...
	<div id="new_discussion">
    	...
    	<form id="chatter_form_editor" action="/{{ Config::get('chatter.routes.root') }}/{{ Config::get('chatter.routes.discussion') }}" method="POST">
        	<div class="row">
	        	<div class="col-md-7">
		        	<!-- TITLE -->
            ...
            <div id="new_discussion_footer">
            	...
            	<a href="/{{ Config::get('chatter.routes.root') }}" class="btn btn-default pull-right" id="cancel_discussion">@lang('chatter::messages.words.cancel')</a>
